...
CREATE TABLE `commandes` (
  `id_cmd` bigint NOT NULL AUTO_INCREMENT,
  `date` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `c_id` bigint DEFAULT NULL,
  PRIMARY KEY (`id_cmd`),
  KEY `FKiva360anap8nhcnp9i34qy5xo` (`c_id`),
  CONSTRAINT `FKiva360anap8nhcnp9i34qy5xo` FOREIGN KEY (`c_id`) REFERENCES `clients` (`id_c`)
